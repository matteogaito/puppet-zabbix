    ...
    supported_versions.each do |zabbix_version|
      ...
      context "on #{os}" do
        ...
        context 'with all defaults' do
          ...
          it { is_expected.to contain_apt__source('zabbix').with_key('name' => 'zabbix-official-repo.asc', 'source' => 'https://repo.zabbix.com/zabbix-official-repo.key') } if facts[:os]['family'] == 'Debian'
